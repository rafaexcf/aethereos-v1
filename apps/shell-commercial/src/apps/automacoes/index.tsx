  ...
  return (
    ...
    >
      <aside style={ASIDE_STYLE}>
        ...
        <div style={SIDEBAR_LABEL_STYLE}>Filtros</div>
        ...
        <div style={SIDEBAR_LABEL_STYLE}>Limitações</div>
        <p
          style={{
            fontSize: 11,
            color: "var(--text-tertiary)",
        ...
        >
          Engine roda no navegador. Requer sessão aberta para gatilhos
          dispararem. Sem retry e sem execução em servidor.
        </p>
      </aside>
